...
import cashDeposit from "../Images/Health-Ins.webp";
    ...
    <div className="ServiceAccount-Mainbox">
      <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
        <div className="contents1">
          ...
          <p>
          customers can access quality healthcare without worrying about the financial burden. It serves as a crucial safety net, ensuring that individuals and families can receive timely medical treatment without compromising their financial stability. </p>
        </div>
