...
import cashDeposit from "../Images/BBPS-image.webp";
      ...
      <div className="ServiceAccount-Mainbox">
        <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
          <div className="contents1">
            <span>BBPS</span>
            <p>
              Secure reliable monthly income by offering essential utility bill
              payment services directly from your shop, catering to the needs of
              every household.{" "}
            </p>
          </div>
        ...
        <div className="contentLmore3">
          <div className="galLmoreBox">
            ...
            <span>
              Join our agency force that already has xxxx+ agents on board
            </span>
