...
import cashDeposit from "../Images/GP-image.png";
    ...
    <div className="ServiceAccount-Mainbox">
      <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
        <div className="contents1">
          ...
          <p>
          GP/Other Air-Fiber Bill Payment services provide a hassle-free way to manage their internet expenses. Whether it's paying monthly bills, topping up data packages, or ensuring uninterrupted connectivity, these services offer convenience and flexibility.</p>
        </div>
