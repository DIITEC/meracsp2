...
import cashDeposit from "../Images/Lic-image.png";
      ...
      <div className="ServiceAccount-Mainbox">
        <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
          <div className="contents1">
            ...
            <p>
            Facilitate easy payment solutions for customers to manage their LIC premiums monthly, quarterly, semi-annually, or annually, ensuring a reliable and recurring income stream for your business. </p>
          </div>
