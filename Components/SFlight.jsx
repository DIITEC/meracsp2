...
import cashDeposit from "../Images/airline.png";
    ...
    <div className="ServiceAccount-Mainbox">
      <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
        <div className="contents1">
          <span>Airline</span>
          <p>
          Our Airline Ticket Booking service provides comprehensive solutions for both domestic and international flights, catering to a variety of travel needs.g.   </p>
        </div>
