...
import cashDeposit from "../Images/cropped-digitalbazar.png";
    ...
    <div className="ServiceAccount-Mainbox">
      <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
        <div className="contents1">
          ...
          <p>
          secure transactions, and doorstep delivery, the digital bazaar brings the world of shopping right to your screen, making it easier than ever to find what you're looking for, whenever you need it.    </p>
        </div>
