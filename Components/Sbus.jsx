...
import cashDeposit from "../Images/busImg.png";
    ...
    <div className="ServiceAccount-Mainbox">
      <div id="serviceAepsCArdSrvs" className="cardServiceSec1">
        <div className="contents1">
          <span>BUS</span>
          <p>
          Interested in stepping into a lucrative industry? Looking to earn high commissions? Explore the excellent opportunity to join the IRCTC agent family.   </p>
        </div>
